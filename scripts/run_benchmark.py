...
def main() -> None:
    root = Path.cwd()
    records, rows = run_benchmark(per_difficulty=6, seed=20260518)
    ...
    draw_grid(easy.puzzle, root / "outputs/figures/example_easy_puzzle.png", "Example easy puzzle")
    draw_grid(expert.puzzle, root / "outputs/figures/example_expert_puzzle.png", "Example expert puzzle")
