...
| Lewis, [Stochastic Optimization Approaches for Solving Sudoku](https://arxiv.org/abs/0805.0697) | Shows that metaheuristics such as genetic algorithms, particle swarm, and simulated annealing have been tried, but are less transparent for this learning project. |
