...
| A002 | A 20-puzzle benchmark is enough for a compact empirical demonstration. | Evidence | The project scope is intentionally small and reproducible. | Yes | Open |
